...
class HyperParameterHandler(object):
    ...
    def readConfigFile(config_file):
        ...
        dic["test_dataset_dir"] = config.get(training_section, "test_dataset_dir", fallback=None)
        dic["test_dataset_type"] = config.get(training_section, "test_dataset_type", fallback=None)
